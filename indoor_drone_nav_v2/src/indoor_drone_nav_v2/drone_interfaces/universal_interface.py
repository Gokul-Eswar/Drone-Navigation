...
class MAVROSInterface(UniversalDroneInterface):
    """PX4/ArduPilot implementation"""

    async def connect(self) -> bool:
        # MAVROS connection logic
        print("Connecting via MAVROS...")
